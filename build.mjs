...
const files=[
  ...
  'enhancements.js','history-bootstrap.js','migraine-fix.js','tracker-upgrades.js','shared-save.js','year-rankings.js','platform-copy.js','storage.js','spotify.js','sw.js','manifest.webmanifest','icon.svg'
];
